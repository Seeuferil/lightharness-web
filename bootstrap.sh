...
echo ""
echo "   사용 가능한 커맨드 (직접 타이핑 또는 자연어로 요청):"
echo "     /harness [목표]   — 에이전트 팀 Blueprint 설계"
echo "     /harness-run      — Blueprint 실행 (큐 자동 감지)"
echo "     /rsm              — 세션 재개 (이전 Task 불러오기)"
echo "     /rsm log          — 세션 종료 (다음 할 일 저장)"
echo ""
echo "   ※ / 자동완성 메뉴에는 표시되지 않습니다. 타이핑으로 실행하세요."
